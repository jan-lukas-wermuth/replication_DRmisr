# Title:      Second Estimation Step: Code for Figure 1 c,f,i and 2 c,f,i (3 b,d,f and 4 b,d,f)
# Author:     Jan-Lukas Wermuth
# Date:       2025-05-06
# Purpose:    This script performs the bootstrap for the plots for C
...
source("functions/MisreportingC_functions.R")
...
save("F_(0|0)_draws_mar_life", file = "results/Bootstrap_results/C_misr/F_(0|0)_draws_mar_life.RData")
save("F_(1|0)_draws_mar_life", file = "results/Bootstrap_results/C_misr/F_(1|0)_draws_mar_life.RData")
save("F_(0|1)_draws_mar_life", file = "results/Bootstrap_results/C_misr/F_(0|1)_draws_mar_life.RData")
save("F_(1|1)_draws_mar_life", file = "results/Bootstrap_results/C_misr/F_(1|1)_draws_mar_life.RData")
...
ggsave(filename = paste0("results/plots/C_misr/OverallEffect_rec.pdf"), plot = p1, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(1_1)-(1_0)_rec.pdf"), plot = p2, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(1_0)-(0_0)_rec.pdf"), plot = p3, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(1_1)-(0_1)_rec.pdf"), plot = p4, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(0_1)-(0_0)_rec.pdf"), plot = p5, device = cairo_pdf, width = 5, height = 5)
...
ggsave(filename = paste0("results/plots/C_misr/OverallEffect_restr_rec.pdf"), plot = p6, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(1_1)-(1_0)_restr_rec.pdf"), plot = p7, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(1_0)-(0_0)_restr_rec.pdf"), plot = p8, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(1_1)-(0_1)_restr_rec.pdf"), plot = p9, device = cairo_pdf, width = 5, height = 5)
ggsave(filename = paste0("results/plots/C_misr/CounterfactualEffect_(0_1)-(0_0)_restr_rec.pdf"), plot = p10, device = cairo_pdf, width = 5, height = 5)
