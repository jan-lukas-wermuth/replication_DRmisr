# Title:      First Estimation Step: Distribution Regression without Misreporting
# Author:     Jan-Lukas Wermuth
# Date:       2025-05-06
# Purpose:    This script performs the estimation described in 
#             the paper in equation (11) without misreporting. 
#             That is, it performs a series of probits that allows
#             to trace out the full conditional distribution of
#             the outcome variable. The results are needed
#             for upper tail probability and decomposition estimates
#             in Figure 1 and 2 for all the plots in which no misreporting
#             is allowed. 
...
save("F_(0|0)_draws_mar_life", file = "results/Bootstrap_results/Y_nomisr/F_(0|0)_draws_mar_life.RData")
save("F_(1|0)_draws_mar_life", file = "results/Bootstrap_results/Y_nomisr/F_(1|0)_draws_mar_life.RData")
save("F_(0|1)_draws_mar_life", file = "results/Bootstrap_results/Y_nomisr/F_(0|1)_draws_mar_life.RData")
save("F_(1|1)_draws_mar_life", file = "results/Bootstrap_results/Y_nomisr/F_(1|1)_draws_mar_life.RData")
...
ggsave(filename = paste0("results/plots/Y_nomisr/CounterfactualEffect_(1|0)-(0|0)_rec.pdf"), plot = p3, device = cairo_pdf)
ggsave(filename = paste0("results/plots/Y_nomisr/CounterfactualEffect_(1|1)-(0|1)_rec.pdf"), plot = p4, device = cairo_pdf)
ggsave(filename = paste0("results/plots/Y_nomisr/CounterfactualEffect_(0|1)-(0|0)_rec.pdf"), plot = p5, device = cairo_pdf)
...
ggsave(filename = paste0("results/plots/Y_nomisr/CounterfactualEffect_(1|0)-(0|0)_restr_rec.pdf"), plot = p8, device = cairo_pdf)
ggsave(filename = paste0("results/plots/Y_nomisr/CounterfactualEffect_(1|1)-(0|1)_restr_rec.pdf"), plot = p9, device = cairo_pdf)
ggsave(filename = paste0("results/plots/Y_nomisr/CounterfactualEffect_(0|1)-(0|0)_restr_rec.pdf"), plot = p10, device = cairo_pdf)
...
ggsave(filename = paste0("results/plots/Y_nomisr/(0|1)_rec.pdf"), plot = p13, device = cairo_pdf)
ggsave(filename = paste0("results/plots/Y_nomisr/(1|1)_rec.pdf"), plot = p14, device = cairo_pdf)
...
ggsave(filename = paste0("results/plots/Y_nomisr/(0|1)_restr_rec.pdf"), plot = p17, device = cairo_pdf)
ggsave(filename = paste0("results/plots/Y_nomisr/(1|1)_restr_rec.pdf"), plot = p18, device = cairo_pdf)
