...
source("NoMisreporting_functions.R")
...
for (i in c("cig", "mar", "mar_life")) {
  for (j in c("nomedical", "medical")) {
    ...
    save(list = paste("yrbs_data_combined_20172019", j, i, sep = "_"), file = paste0("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_med/", paste("yrbs_data_combined_20172019", j, i, sep = "_"), ".RData"))
  }
}
for (i in c("cig", "mar", "mar_life")) {
  for (j in c("norecreational", "recreational")) {
    assign(paste("yrbs_data_combined_20172019", j, i, sep = "_"), get(paste("yrbs_data_combined_20172019", j, i, sep = "_")) %>% rename(!!!setNames(as.character(1:6), paste(i, 1:6, sep = ""))) %>% select(-2))
    assign(paste("yrbs_data_combined_20172019", j, i, sep = "_"), as.data.frame(cbind(scale(get(paste("yrbs_data_combined_20172019", j, i, sep = "_"))[,1:8]), get(paste("yrbs_data_combined_20172019", j, i, sep = "_"))[,9:14])))
    save(list = paste("yrbs_data_combined_20172019", j, i, sep = "_"), file = paste0("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/", paste("yrbs_data_combined_20172019", j, i, sep = "_"), ".RData"))
  }
}

##############################################################
# DR for cigarettes and marijuana separately
##############################################################
...
for (i in c("cig", "mar", "mar_life")) { 
  for (j in c("nomedical", "medical")) {
    for (k in 1:6) {
      if (i == "cig"){
        formula <- paste(paste(i, k, sep = ""), "~", "year + sex + median_income + unemployment_rate + tax_percent")
        assign(paste(i, "DR", j, k, sep = "_"), glm(formula = formula, family = binomial(link = "probit"), data = get(paste("yrbs_data_combined_20172019", j, i, sep = "_"))))
        save(list = paste(i, "DR", j, k, sep = "_"), file = paste("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_med", paste(i, "DR", j, k, ".RData", sep = "_"), sep = "/"))
      }
      if (i == "mar"){
        formula <- paste(paste(i, k, sep = ""), "~", "year + sex + median_income + unemployment_rate + mar_prices_medium")
        assign(paste(i, "DR", j, k, sep = "_"), glm(formula = formula, family = binomial(link = "probit"), data = get(paste("yrbs_data_combined_20172019", j, i, sep = "_"))))
        save(list = paste(i, "DR", j, k, sep = "_"), file = paste("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_med", paste(i, "DR", j, k, ".RData", sep = "_"), sep = "/"))
      }
      if (i == "mar_life"){
  ...
  for (j in c("norecreational", "recreational")) {
    for (k in 1:6) {
      if (i == "cig"){
        formula <- paste(paste(i, k, sep = ""), "~", "year + sex + median_income + unemployment_rate + tax_percent")
        assign(paste(i, "DR", j, k, sep = "_"), glm(formula = formula, family = binomial(link = "probit"), data = get(paste("yrbs_data_combined_20172019", j, i, sep = "_"))))
        save(list = paste(i, "DR", j, k, sep = "_"), file = paste("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec", paste(i, "DR", j, k, ".RData", sep = "_"), sep = "/"))
      }
      if (i == "mar"){
        formula <- paste(paste(i, k, sep = ""), "~", "year + sex + median_income + unemployment_rate + mar_prices_medium")
        assign(paste(i, "DR", j, k, sep = "_"), glm(formula = formula, family = binomial(link = "probit"), data = get(paste("yrbs_data_combined_20172019", j, i, sep = "_"))))
...
for (i in list.files("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec")) { # Load all the DR results and the data
  load(file = paste("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec", i, sep = "/"))
}
for (i in list.files("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_med")) { # Load all the GJRM results and the data
  load(file = paste("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_med", i, sep = "/"))
}
...
for (i in c("cig", "mar", "mar_life")) {
  for (j in c("nomedical", "medical")) {
    ...
    save(list = paste("X", j, i, sep = "_"), file = paste0("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_med/", paste("X", j, i, sep = "_"), ".RData"))
  }
}
for (i in c("cig", "mar", "mar_life")) {
  for (j in c("norecreational", "recreational")) {
    assign(paste("X", j, i, sep = "_"), get(paste("yrbs_data_combined_20172019", j, i, sep = "_")) %>% select(-c(paste0(i, 1:6), "recreational")))
    save(list = paste("X", j, i, sep = "_"), file = paste0("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/", paste("X", j, i, sep = "_"), ".RData"))
  }
}
...
save("F_(0_0)_draws_mar", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(0_0)_draws_mar.RData")
save("F_(1_0)_draws_mar", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(1_0)_draws_mar.RData")
save("F_(0_1)_draws_mar", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(0_1)_draws_mar.RData")
save("F_(1_1)_draws_mar", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(1_1)_draws_mar.RData")
...
save("F_(0_0)_draws_mar_life", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(0_0)_draws_mar_life.RData")
save("F_(1_0)_draws_mar_life", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(1_0)_draws_mar_life.RData")
save("F_(0_1)_draws_mar_life", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(0_1)_draws_mar_life.RData")
save("F_(1_1)_draws_mar_life", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(1_1)_draws_mar_life.RData")
...
save("F_(0_0)_draws_cig", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(0_0)_draws_cig.RData")
save("F_(1_0)_draws_cig", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(1_0)_draws_cig.RData")
save("F_(0_1)_draws_cig", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(0_1)_draws_cig.RData")
save("F_(1_1)_draws_cig", file = "/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec/F_(1_1)_draws_cig.RData")


################ Step 2: Compute robust standard errors ####################
rm(list=ls())

for (i in list.files("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec")) { # Load all the GJRM results and the data
  load(file = paste("/Workspace/YRBS_DR_nomis/DistributionRegression_20172019_rec", i, sep = "/"))
}
...
for (drug in c("cig", "mar", "mar_life")) {
  ...
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/OverallEffect_rec.pdf"), plot = p1, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(1_1)-(1_0)_rec.pdf"), plot = p2, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(1_0)-(0_0)_rec.pdf"), plot = p3, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(1_1)-(0_1)_rec.pdf"), plot = p4, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(0_1)-(0_0)_rec.pdf"), plot = p5, device = cairo_pdf)
  ...
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/OverallEffect_restr_rec.pdf"), plot = p6, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(1_1)-(1_0)_restr_rec.pdf"), plot = p7, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(1_0)-(0_0)_restr_rec.pdf"), plot = p8, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(1_1)-(0_1)_restr_rec.pdf"), plot = p9, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/CounterfactualEffect_(0_1)-(0_0)_restr_rec.pdf"), plot = p10, device = cairo_pdf)
  ...
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(0_0)_rec.pdf"), plot = p11, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(1_0)_rec.pdf"), plot = p12, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(0_1)_rec.pdf"), plot = p13, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(1_1)_rec.pdf"), plot = p14, device = cairo_pdf)
  ...
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(0_0)_restr_rec.pdf"), plot = p15, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(1_0)_restr_rec.pdf"), plot = p16, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(0_1)_restr_rec.pdf"), plot = p17, device = cairo_pdf)
  ggsave(filename = paste0("/Plots/DistributionRegression_20172019_rec/DR/", drug, "/(1_1)_restr_rec.pdf"), plot = p18, device = cairo_pdf)
}
